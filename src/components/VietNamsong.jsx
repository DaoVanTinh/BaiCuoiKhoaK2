...
import { getRandomVietnamSongs } from "../services/songService";
import { nameArtist } from "../services/artistService";
import { List, Button } from "antd";
import { PlayCircleOutlined } from "@ant-design/icons";
import { useNavigate } from "react-router-dom";

export default function VietnamSong({ limit = 5 }) {
  ...
  useEffect(() => {
    async function loadSongsAndArtists() {
      const vietnamSongs = await getRandomVietnamSongs(limit);
      const artistList = await nameArtist();
      setSongs(vietnamSongs);
      ...
      <List
        ...
        renderItem={(item) => {
          ...
          return (
            ...
            >
              <div className="relative group w-[152px] h-[152px] rounded-md overflow-hidden">
                <img
